...
class AnnoyIndex(Annoy):
    ...
    def add_item(self, i, vector):
        ...
        return super(AnnoyIndex, self).add_item(self.check_item(i, building=True),
                                                self.check_list(vector))
    ...
    def get_nns_by_item(self, i, n, search_k=-1, include_distances=False):
        ...
        return super(AnnoyIndex, self).get_nns_by_item(self.check_item(i), n, search_k,
                                                       include_distances)
